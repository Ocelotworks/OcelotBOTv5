...
JSZM.prototype = {
    ...
    setSerialData: function (data) {
        this.savedFlags = this.get(16);
        let loadData = this.deserialize(data);
    ...
    run: function* () {
        ...
        var addr, fetch, flagset, init, move, opfetch, pcfetch, pcget, pcgetb, pcgetu, predicate, propfind, ret, store,
            xfetch, xstore;
