...
module.exports = {
    ...
    run: async function(context, bot){
        ...
        // Username
        imageRequest.components.push(bot.util.imageProcessorOutlinedText(target.global_name || target.tag, USERNAME_X, USERNAME_Y, PROFILE_WIDTH-USERNAME_X, USERNAME_SIZE, USERNAME_SIZE))
