...
module.exports = {
    ...
    run:  function(message, args, bot){
        ...
        try {
            ...
            let attachment = new Discord.Attachment(`https://barcode.tec-it.com/barcode.ashx?data=${encodeURIComponent(message.content.substring(args[0].length + 1))}&code=MaxiCode&multiplebarcodes=false&translate-esc=false&unit=Fit&dpi=396&imagetype=gif&rotation=0&color=%23000000&bgcolor=%23ffffff&qunit=Mm&quiet=0`, "qr.png");
