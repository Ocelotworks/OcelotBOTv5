...
module.exports = {
    name: "Guess The Song (Old Version)",
    ...
    init: async function init(bot){
        ...
        bot.util.standardNestedCommandInit("guess_old");
    ...
    run:  async function run(message, args, bot) {
        if (args[1]) {
            await bot.util.standardNestedCommand(message, args, bot, 'guess_old', runningGames, () => {
