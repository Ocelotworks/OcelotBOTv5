    ...
    run: function run(message, args, bot){
        ...
        if(timeMessage === "Invalid Date"){
            ...
            if(!message.getBool("wholesome")) {
                ...
                if (time.getHours() === 2 && time.getMinutes() === 0 && time.getSeconds() < 10) emoji = "I'm in the corner skanking  - ";
                if (twelveHourTime === 2 && time.getMinutes() === 0) emoji = "Be there 2 o'clock at the fountain down the road - ";
                if (twelveHourTime === 1 && time.getMinutes() === 45) emoji = "It's a quarter to two and I'm done, I'm hanging up on you - ";
                ...
                if (time.getHours() === 19 && time.getMinutes() === 0) emoji = "7 o'clock in the evening watching something stupid on TV - ";
                if (time.getHours() === 20 && time.getMinutes() === 0) emoji = "It's only 8 o'clock but you're already bored - ";
                if (time.getHours() === 21 && time.getMinutes() === 0) emoji = "It's 9 in the afternoon, and your eyes are the size of the moon - ";
