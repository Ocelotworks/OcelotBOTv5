...
module.exports = {
    ...
    run:  function(message, args, bot){
        if(!args[1]){
            ...
            request({
                encoding: null,
                url: `http://api.screenshotlayer.com/api/capture?access_key=${config.get("API.screenshotLayer.key")}&url=${encodeURIComponent(args[1].startsWith("http") ? args[1] : "http://"+args[1])}&viewport=1920x1080&width=480}`
