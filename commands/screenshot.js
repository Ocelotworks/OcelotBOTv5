...
module.exports = {
    ...
    run:  function(message, args, bot){
        if(!args[1]){
            ...
            request({
                encoding: null,
                url: `http://api.screenshotlayer.com/api/capture?access_key=${config.get("Commands.screenshot.key")}&url=${encodeURIComponent(args[1])}&viewport=${config.get("Commands.screenshot.viewport")}&width=${config.get("Commands.screenshot.width")}`
